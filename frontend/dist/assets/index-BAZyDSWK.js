import{cE as g,cT as C,cU as w,cW as k,cX as $,cZ as m,c_ as d,cO as l}from"./index-Cf4JPuoH.js";import{n as x,c as f,r as v}from"./index-DjryHvFF.js";import{o as _}from"./if-defined-DFTrRwBX.js";import{e as z,n as E}from"./ref-CPYqc3lj.js";const h=g({isLegalCheckboxChecked:!1}),u={state:h,subscribe(e){return w(h,()=>e(h))},subscribeKey(e,t){return C(h,e,t)},setIsLegalCheckboxChecked(e){h.isLegalCheckboxChecked=e}},O=k`
  label {
    display: inline-flex;
    align-items: center;
    cursor: pointer;
...
`;var b=function(e,t,o,s){var n=arguments.length,c=n<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,o):s,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")c=Reflect.decorate(e,t,o,s);else for(var r=e.length-1;r>=0;r--)(i=e[r])&&(c=(n<3?i(c):n>3?i(t,o,c):i(t,o))||c);return n>3&&c&&Object.defineProperty(t,o,c),c};const P={lg:"md",md:"sm",sm:"sm"};let a=class extends m{constructor(){super(...arguments),this.inputElementRef=z(),this.checked=void 0,this.disabled=!1,this.size="md"}render(){const t=P[this.size];return d`
