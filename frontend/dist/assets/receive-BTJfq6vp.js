import{cW as y,cX as v,cY as N,cZ as x,c_ as u,cG as c,cJ as w,dj as h,dk as f,d5 as R,d6 as A,d2 as I,cI as S}from"./index-Cf4JPuoH.js";import{n as $,c as C,U as T,r as b}from"./index-DjryHvFF.js";import{o as _}from"./if-defined-DFTrRwBX.js";import"./index-DNpy9kj1.js";import"./index-ikdbqXbd.js";const O=y`
  button {
    width: 100%;
    display: flex;
    align-items: center;
...
`;var g=function(e,t,o,i){var s=arguments.length,r=s<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(e,t,o,i);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(r=(s<3?n(r):s>3?n(t,o,r):n(t,o))||r);return s>3&&r&&Object.defineProperty(t,o,r),r};let p=class extends x{constructor(){super(...arguments),this.networkImages=[""],this.text=""}render(){return u`
    ...
    </wui-flex>`}};p.styles=[v,N,O];g([$({type:Array})],p.prototype,"networkImages",void 0);g([$()],p.prototype,"text",void 0);p=g([C("wui-compatible-network")],p);const E=y`
    ...
    >
      ...
      >
        <wui-qr-code
          ...
          uri=${this.address}
          ?arenaClear=${!0}
          color=${_(f.state.themeVariables["--apkt-qr-color"]??f.state.themeVariables["--w3m-qr-color"])}
