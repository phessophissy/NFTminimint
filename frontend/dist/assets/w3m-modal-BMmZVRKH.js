import{di as x,d$ as ae,d2 as c,d3 as de,cW as $,cX as L,cZ as y,c_ as d,d8 as _,cY as ue,c$ as D,cG as g,dj as j,dW as he,cH as U,cO as R,da as F,d0 as pe,cJ as O,dL as z,dk as me,e0 as fe,e1 as we}from"./index-Cf4JPuoH.js";import{c as w,n as l,r as u,U as ne}from"./index-DjryHvFF.js";import{o as W}from"./if-defined-DFTrRwBX.js";import"./index-C6-wrYey.js";import"./index-DNpy9kj1.js";import{H as ee}from"./HelpersUtil-DY7uv9jK.js";import{C as V}from"./ConstantsUtil-COJBkkkj.js";import"./index-DbrfZRCb.js";import"./index-BuFKZRQm.js";import"./index-ChNdxAC4.js";import"./index-JrYhG9G9.js";import{S as be}from"./SwapController-CIhaiPM6.js";import"./index-C8c87VY9.js";import"./index-DygunZbn.js";import"./index-IYxBeqlz.js";import"./index-darZNVYe.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},ge=$`
  :host {
    display: block;
