import{d0 as h,cZ as p,cO as c,c_ as a,cH as x,d5 as b,cG as g,d6 as v,d2 as C,cW as m,cX as _,cY as $}from"./index-Cf4JPuoH.js";import{c as w,r as T}from"./index-DjryHvFF.js";import"./index-IYxBeqlz.js";const O=h``;var R=function(n,e,r,o){var i=arguments.length,t=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,r):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,o);else for(var l=n.length-1;l>=0;l--)(s=n[l])&&(t=(i<3?s(t):i>3?s(e,r,t):s(e,r))||t);return i>3&&t&&Object.defineProperty(e,r,t),t};let f=class extends p{render(){const{termsConditionsUrl:e,privacyPolicyUrl:r}=c.state;return!e&&!r?null:a`
    ...
    `}howDoesItWorkTemplate(){return a` <wui-link @click=${this.onWhatIsBuy.bind(this)}>
      ...
      How does it work?
    </wui-link>`}onWhatIsBuy(){x.sendEvent({type:"track",event:"SELECT_WHAT_IS_A_BUY",properties:{isSmartAccount:b(g.state.activeChain)===v.ACCOUNT_TYPES.SMART_ACCOUNT}}),C.push("WhatIsABuy")}};f.styles=[O];f=R([w("w3m-onramp-providers-footer")],f);const P="https://reown.com",W=m`
  .reown-logo {
    height: 24px;
  }
