import{cG as S,d3 as g,cO as h,cH as c,di as _,d2 as s,cJ as f,cI as C,cW as D,cZ as b,da as d,c_ as u,d0 as W,dK as $,d4 as P}from"./index-Cf4JPuoH.js";import{c as m,r as E}from"./index-DjryHvFF.js";import{W as y}from"./index-CgI1sFp8.js";import"./index-BuFKZRQm.js";import"./index-IYxBeqlz.js";import{e as N,n as T}from"./ref-CPYqc3lj.js";import"./index-C8c87VY9.js";import"./index-BpfmglRo.js";import"./index-DbrfZRCb.js";import"./if-defined-DFTrRwBX.js";import"./index-WG6BssrH.js";var F=function(a,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var l=a.length-1;l>=0;l--)(o=a[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends y{constructor(){super(...arguments),this.onOtpSubmit=async e=>{var t,r;try{if(this.authConnector){const n=S.state.activeChain,i=g.getConnections(n),o=(t=h.state.remoteFeatures)==null?void 0:t.multiWallet,l=i.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),n)await g.connectExternal(this.authConnector,n);else throw new Error("Active chain is not set on ChainController");if((r=h.state.remoteFeatures)!=null&&r.emailCapture)return;if(h.state.siwx){_.close();return}if(l&&o){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}_.close()}}catch(n){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:C.parseError(n)}}),n}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=F([m("w3m-email-verify-otp-view")],I);const U=D`
  wui-icon-box {
